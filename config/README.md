...
- `PWAThemeColor` (optional `#RRGGBB` string): overrides the manifest theme color for that tenant. Known skins use their mapped color when omitted; unknown skins use a neutral gray.
